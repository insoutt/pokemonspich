...
class Form extends Component<Props, State> {
            ...
            <form onSubmit={event => event.preventDefault()}>
                <div className="grid">
                    <div className="grid-item">
                        <label htmlFor="name">Nombre:</label> <input id="name" value={this.state.name}  onChange={(event) => this.update(event, 'name')} type="text"/>
                    </div>
                    <div className="grid-item">
                        <label htmlFor="attack">Ataque:</label> <input id="attack" value={this.state.attack} onChange={(event) => this.update(event, 'attack')} type="text"/>
                    </div>
                    <div className="grid-item">
                        <label htmlFor="image">Imagen:</label> <input id="image" value={this.state.image} onChange={(event) => this.update(event, 'image')} type="text"/>
                    </div>
                    <div className="grid-item">
                        <label htmlFor="defense">Defensa:</label> <input id="defense" value={this.state.defense} onChange={(event) => this.update(event, 'defense')} type="text"/>
                    </div>

                    <div className="grid-item">
                        <label htmlFor="type">Tipo:</label>
                        <select id="type" value={this.state.type} onChange={(event) => this.update(event, 'type')}>
                    ...
                    <div className="grid-item">
                        <label htmlFor="hp">HP:</label> <input id="hp" value={this.state.hp} onChange={(event) => this.update(event, 'hp')} type="text"/>
                    </div>
                </div>
    ...
    private update(event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>, name: InputType) {
